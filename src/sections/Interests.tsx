...
export const Interests = () =>{
    ...
    const interestBody = `My goal is to build low-friction tools and apps that make people’s lives easier, help create the frameworks and systems that can get people closer to their goals, become the best version of myself - and do as much as I can to help build a more empathetic and human-centred world. 
\n\n
