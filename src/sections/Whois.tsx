...
export const Whois = () =>{
    ...
    const welcomeBody = `Hey, I’m Sanjay — a developer from Winnipeg with a background in computer science and history. I care about kindness, honesty, always improving, and always finding joy in whatever I’m doing :)
